...
cm-department-Command-description = Ви – Керівництво цього судна та операції, керуйте і кооперуйте загони та їхню підтримку щоб досягти перемоги. Не пийте алкоголь під час служби.
...
cm-department-AuxiliarySupport-description = Керуйте та надавайте вогневу, розвідницьку й загальну підтримку морпіхам на землі.
...
# Мисливці
department-CMHunters = Мисливці
cm-department-Hunters-description = Мисливці, що жадають слави та трофеїв.

# Виживші
department-CMSurvivor = Вцілілі
cm-department-Survivor-description = Протримайтеся до моменту прибуття порятунку... Якщо він звісно буде.
